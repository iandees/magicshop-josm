...
public class MagicshopPlugin extends Plugin {
	...
	public MagicshopPlugin(PluginInformation info) {
		super(info);
...
//		MainMenu.add(Main.main.menu.editMenu, new BuildingSizeAction());
	...
	@Override public void mapFrameInitialized(MapFrame oldFrame, MapFrame newFrame) {
		if (oldFrame==null && newFrame!=null) {
			Main.map.addMapMode(new IconToggleButton(new MagicshopSelectAction(Main.map)));
		}
	}
}
